 ...
 */
 ...
 function trapezeRectangle(side) {
   var s = (side || 1)/2;
   var coords = [];
   var normals = [];
   var texCoords = [];
   ...
   // Créer la face du carré
   face( [-s,-s,s, s,-s,s, s,s,s, -s,s,s], [0,0,1] );
   
   // Créer le triangle sous le carré   
   coords.push(-s,-2*s,s);
   normals.push(0,0,1);
   indices.push(0,1,4);
   texCoords.push(1,1);
...
function uvCylinder(radius, height, slices, noTop, noBottom) {
   ...
   if (!noTop) {
      ...
      for (i = 0; i < slices; i++) {
   	...
   	/*
    alert("vertices : " + vertices[0]);
	alert("vertices : " + normals);
	alert("vertices : " + texCoords);
	alert("vertices : " + indices);
   */
